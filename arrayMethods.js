...
const sixteenthCenturyInventors = inventors.filter( i => i.year >= 1500 && i.year < 1600);
...
const birthYears = inventors.map(i => i.year);
...
const longestLivingInventors = inventors.sort((a, b) => (b.passed - b.year) - (a.passed - a.year));
...
const edison = inventors.find(i => i.last === 'Edison');
console.log(edison);
